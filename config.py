...
import twittercomments.encoders
import os
import logging
import datetime
...
server_settings = {
    ...
    "cookie_secret"     :   "85cdbdf7-12bf-44cf-9f64-4c298fc7421f"
}
...
myapp = {
    "app_name"          :   "twittercomments",
    "default_format"    :   "json",
    "supported_formats" :   ["json", "csv", "xml", "html"],
    "encoder"           :   {
            "json"  :   json,
            "csv"   :   twittercomments.encoders.JsonToCsv(),
            "xml"   :   twittercomments.encoders.JsonToXml()
    },
