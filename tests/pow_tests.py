...
class TestClass:
    ...
    def test_server(self):
        ...
        import twittercomments.server
        import requests
        import twittercomments.config as cfg
        import time
        p = Process(target=twittercomments.server.main)
        p.start()
    ...
    def test_sql_generate_model(self):
        ...
        import twittercomments.generate_model as gm
        import uuid
        import os.path
        ret = gm.generate_model(MODELNAME, "sql", appname="twittercomments")
    ...
    def test_sql_model_type(self):
        ...
        from twittercomments.models.sql.pow_test_model import PowTestModel
        m = PowTestModel()
    ...
    def test_sql_dbsetup(self):
        ...
        import twittercomments.init_sqldb_environment
        import os
        os.chdir("..")
        r = twittercomments.init_sqldb_environment.init_migrations()
        assert r == True
    ...
    def test_sql_migration(self):
        ...
        import twittercomments.generate_migration
        import os
        os.chdir("..")
        script = twittercomments.generate_migration.generate_migration(message="pow_test")
    ...
    def test_sql_dbupdate(self):
        ...
        import twittercomments.update_db
        import os, time
        ret = None
        os.chdir("..")
        time.sleep(1)
        try:
            ret = twittercomments.update_db.migrate("up")
    ...
    def test_tinydb_generate_model(self):
        ...
        import uuid
        import os.path
        ret = gm.generate_model(MODELNAME, "tinydb", appname="twittercomments")
        # generate model returns true in case of success
        assert ret is True
    ...
    def test_tinydb_model_type(self):
        ...
        from twittercomments.models.tinydb.pow_test_model import PowTestModel
        m = PowTestModel()
        assert isinstance(m, PowTestModel)
