...
from twittercomments.database.sqldblib import Base, Session, engine
from twittercomments.config import myapp
from twittercomments.config import routes
...
class Application(tornado.web.Application):
    ...
    def import_all_handlers(self):
        ...
        import importlib
        for m in mods:
            #print("importing: " + 'twittercomments.handlers.' + m)    
            try:
                mod = importlib.import_module('twittercomments.handlers.' + m)
            except:
                pass
            #print(dir(mod))
