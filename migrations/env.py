...
from twittercomments.powlib import get_class_name
from twittercomments.config import myapp
from twittercomments.application import log_handler
import logging
...
import importlib
for m in mods:
    mod = importlib.import_module('twittercomments.models.sql.' + m)
...
#from twittercomments.dblib import Base
